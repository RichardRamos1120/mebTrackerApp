...
const Page = async () => {
    ...
    const res = await fetch('https://072f-120-29-78-26.ngrok-free.app/api/ethiopia',{
        next: { revalidate: 0 },
      });

    const data = await res.json();

    let dataList = data.ethiopiaData[data.ethiopiaData.length - 1];
    ...
    data.ethiopiaData.forEach((item) => {
    ...
    return (
        <div className='main'>
            ...
            <div className="top-main">
                <div>
                    <h1 className="font-600">Ethiopia</h1>
                    <p>ethiopia is a country in Africa.</p>
                </div>
            ...
            <div className="mid-main">
                ...
                <div className="container-card">
                    <Map lng={Number(dataList.longitude)} lat={Number(dataList.latitude)} text="Ethiopia"  />
                </div>
            </div>
        </div>
    );
