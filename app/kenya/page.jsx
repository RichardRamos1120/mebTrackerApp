...
const Page = async () => {
    ...
    const res = await fetch('https://072f-120-29-78-26.ngrok-free.app/api/kenya',{
        next: { revalidate: 0 },
      });

    const data = await res.json();
    // console.log(data.kenyaData[data.kenyaData.length - 1])
    let dataList = data.kenyaData[data.kenyaData.length - 1];
    ...
    return (
        <div className='main'>
            ...
            <div className="top-main">
                <div>
                    <h1 className="font-600">kenya</h1>
                    <p>kenya is a country in Africa.</p>
                </div>
            ...
            <div className="mid-main">
                ...
                <div className="container-card">
                    <Map lng={Number(dataList.longitude)} lat={Number(dataList.latitude)} text="kenya"  />
                </div>
            </div>
        </div>
    );
