...
const Page = async () => {
    ...
    const res = await fetch('https://072f-120-29-78-26.ngrok-free.app/api/congo',{
        next: { revalidate: 0 },
      });

    const data = await res.json();
    // console.log(data.congoData[data.congoData.length - 1])
    let dataList = data.congoData[data.congoData.length - 1];
    ...
    return (
        <div className='main'>
            ...
            <div className="top-main">
                <div>
                    <h1 className="font-600">Congo</h1>
                    <p>Congo is a country in Africa.</p>
                </div>
