...
const Page = async () => {
    ...
    const res = await fetch('https://072f-120-29-78-26.ngrok-free.app/api/southsudan',{
        next: { revalidate: 0 },
      });

    const data = await res.json();
    // console.log(data.southsudanData[data.southsudanData.length - 1])
    let dataList = data.southsudanData[data.southsudanData.length - 1];
    ...
    data.southsudanData.forEach((item) => {
    ...
    return (
        <div className='main'>
            ...
            <div className="top-main">
                <div>
                    <h1 className="font-600">southsudan</h1>
                    <p>southsudan is a country in Africa.</p>
                </div>
            ...
            <div className="mid-main">
                ...
                <div className="container-card">
                    <Map lng={Number(dataList.longitude)} lat={Number(dataList.latitude)} text="southsudan"  />
                </div>
            </div>
        </div>
    );
